Ball (for now) game done with bevy

![gamplay_screenshot](<doc/Screenshot 2025-12-22 101701.png>)

Left  Click to create a Blue ball that goes right  
...
Based on https://bevy.org/examples/picking/mesh-picking/